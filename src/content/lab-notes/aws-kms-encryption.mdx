...
awsServices: ["KMS", "Encryption CLI", "EC2", "IAM", "Systems Manager"]
...
> 💡 **Portfolio Tip:** Insert a screenshot of the AWS KMS console showing the key status as "Enabled" along with its ARN here.
...
> 💡 **Portfolio Tip:** Insert a terminal screenshot showing the unreadable, randomized characters (ciphertext) of the encrypted file here.
