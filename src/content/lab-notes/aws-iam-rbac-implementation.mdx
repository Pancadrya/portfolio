...
> 💡 **Portfolio Tip:** Insert a screenshot of the JSON format of the EC2-Admin Customer Inline Policy here to demonstrate your ability to read and write IAM syntax.
...
> 💡 **Portfolio Tip:** Insert a screenshot of the "Failed to stop the instance. You are not authorized..." error message when logged in as user-2. This perfectly visualizes your security guardrails working in action.
