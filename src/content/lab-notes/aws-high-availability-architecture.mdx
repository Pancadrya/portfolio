...
awsServices: ["EC2", "Auto Scaling", "ALB", "RDS", "VPC"]
...
1. Distribute incoming web traffic automatically.
2. Recover failed servers autonomously (self-healing).
3. Protect data against a single database instance failure.
4. Decouple the web, application, and database tiers using security best practices (Defense in Depth).
...
> 💡 **Portfolio Tip:** Insert a screenshot of the final comprehensive architecture diagram (usually provided in the lab or recreated via draw.io) showcasing the ALB, Private Subnet ASG, Multi-AZ RDS, and Dual NAT Gateways here.
